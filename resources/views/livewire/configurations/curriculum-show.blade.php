<div>
    <div class="w-full">
        ...
        <div class="flex justify-between mb-2">
            <a href="{{ route('courses.show', $curriculum->course) }}" class="bg-red-500 hover:bg-red-400 border px-2 py-1 text-sm text-white rounded-lg" >{{ _('Back') }}</a>
            <button class="bg-green-500 hover:bg-green-400 border px-2 py-1 text-sm text-white rounded-lg" wire:click="updateCurriculum">{{ _('Update') }}</button>
        </div>
        <div>
