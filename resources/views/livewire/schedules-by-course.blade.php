<div>
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 bg-white border-b border-gray-200 flex md:flex-row flex-col space-x-2 min-w-full">
            ...
            <div class="flex flex-col w-1/4 space-y-2">
                    ...
                    <div class="w-3/4">
                        <x-select class="text-sm w-full" wire:model="selectedFaculty">
                            ...
                            <option value="{{ $faculty->id }}"
                                class="{{ $faculty->hasNoUnits() ? 'text-red-500' : '' }}">{{ $faculty->name }} (RU:
                                {{ $faculty->countRemainingUnits() }})</option>
                            @endforeach
                        </x-select>
                    </div>
                ...
                <div class="flex justify-end mx-2">
                    ...
                    <a href="{{ route('sections.show', $sectionModel) }}"
                        class="px-2 py-1 text-xs text-white rounded-lg shadow-sm bg-green-500 hover:bg-green-300 ">
